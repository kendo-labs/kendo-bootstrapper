...
exports.edit_file = function(root, filename, line, col, callback) {
    dispatch(
        ...
        function win() {
	    locate_application([ "notepad++.exe", "gvim.exe", "notepad.exe" ], function(err, cmd){
...
exports.locate_code_editor = function(callback) {
    dispatch(
        function linux() {
            locate_application([ "gedit", "gvim", "emacs" ], callback);
        },
        function win() {
            locate_application([ "notepad++.exe", "gvim.exe", "notepad.exe" ], callback);
        },
        function mac() {
            locate_application([ "sublime", "gvim" ], callback);
        }
    )
};
