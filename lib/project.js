...
function load_assets(options, callback) {
    ...
    var code = "document.write(" + JSON.stringify(assets()) + ")";
    if (!proj.config.preview_themebuilder)
    ...
    function proj_url(rel) {
        return "http://_BSHOST_/@proj/" + proj.id + "/" + rel;
    }
    ...
    UTILS.fs_find(proj.path, {
        ...
        finish: function() {
            ...
            if (args.js && args.css_common && args.css_black && args.jquery) {
                ...
                code += "\n\nKENDO_THEMEBUILDER_OPTIONS = " + JSON.stringify(options, null, 4) + ";";
            }

            code += "\n\n" + [ "window.onload = function(){ setTimeout(function(){",
                               "  var script = document.createElement('script');",
                               "  script.src = 'http://_BSHOST_/kendo/themebuilder/bootstrap.js';",
    ...
    function assets() {
        ...
        loads.push("<script>/*<![CDATA[*/__THIS_PAGE_FILES__ = " +
                   ...
                   "/*]]*/</script>");
        loads.push("<script src=\"http://_BSHOST_/js/rpc.js\"></script>");
        loads.push("<script src=\"http://_BSHOST_/js/autorefresh.js\"></script>");
        return loads.join("\n");
    }
};
